...
SELECT MD5('MERN') #In SQL, MD5 usually refers to a built-in hash function (often named MD5() or similar) that takes some input (text/bytes) and returns an MD5 digest — a 128-bit (16-byte) value, commonly shown as a 32-character hexadecimal string.
